...
const LifeStyleEditor = () => {
  ...
  return (
    <div>
      ...
      {lifeStyleStep === "OtherLifestyles" && <OtherLifestyles setLifeStyleStep={setLifeStyleStep} usage={"mypage"} />}
      {lifeStyleStep === "Done" && <Done setLifeStyleStep={setLifeStyleStep} usage={"mypage"} />}
    </div>
  );
};
