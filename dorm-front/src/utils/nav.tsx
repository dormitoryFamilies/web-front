    ...
    return (
        ...
        >
            ...
            <g clipPath="url(#prefix__clip0_922_3601)">
                ...
                />
                <path
                    d="M20.632 17.12a.75.75 0 100-1.5.75.75 0 000 1.5z"
                    fill="#E70050"
                />
                <path
    ...
    return (
        ...
        >
            <g clipPath="url(#prefix__clip0_922_3611)">
                <path
                    d="M19.57 17.5c-.43 0-.77.34-.77.77s.34.77.77.77.77-.34.77-.77-.34-.77-.77-.77z"
                    fill="#BEBEBE"
                />
                <path
